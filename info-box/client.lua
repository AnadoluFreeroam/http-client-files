...
alertTypes = {
	info = {"Informação", "files/images/info.png", {0, 102, 255}, "files/sounds/bulle.wav"},
	jail = {"Preço", "files/images/ajail.png", {205, 0, 0}, "files/sounds/star.wav"},
	...
	aduty = {"Admin", "files/images/aduty.png", {255, 255, 255}, "files/sounds/victory.wav"},
