...
function shiftUpGUI()
	...
	for i=config.lines,2,-1 do
		local y = config.startY*screenY + (config.iconHeight*(i-0.8)) + (config.iconHeight - config.textHeight)/2
...
--	outputChatBox(width)
--	outputChatBox("25")
--	local rectangle = dxRectangle:create(x,y,width,25,{255,0,0,100})
