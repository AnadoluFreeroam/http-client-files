...
function draw()
    ...
    for i=1, show do
        ...
        if(cords[id])then
            ...
            dxDrawRectangle(left + slotwidth * i - smooth + (slotwidth / 2 - 1), top + 10, 2, 10, tocolor(0, 102, 255, alpha))
    ...
    dxDrawText("➤", left + 4, top + 26 + 2, left + ((show + 3) * slotwidth) + 30, 0, tocolor(0, 102, 255, 255), 1, font1, "center", "top", false, false, false, false, false, 90)
...
addEvent("anadolu:pusulakapat",true)
addEventHandler("anadolu:pusulakapat",root,function()
	removeEventHandler("onClientRender", getRootElement(), draw)
end)

addEvent("anadolu:pusulaac",true)
addEventHandler("anadolu:pusulaac",root,function()
