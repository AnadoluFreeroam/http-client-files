...
local classInfo = {
	...
	btn = {className = 'Button', width= 115, height = 20, padding = {0, 4}},
...
function _buildWindow(wnd, baseWnd, parentWnd)
	...
	elseif wndClass == 'btn' then
		elem = guiCreateButton(relX, relY, relWidth, relHeight, wnd.text or wnd.id or '', true, parentWnd.element,wnd.r,wnd.g,wnd.b)
	--	guiSetProperty(elem, 'NormalTextColour', 'FFFFFFFF')
	--	guiSetProperty(elem, 'HoverTextColour', 'FF999999')
	--	guiSetProperty(elem, 'PushedTextColour', 'FF1177FF')
--		guiSetFont(elem, 'default-bold-small')
